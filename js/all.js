 ...
 */
    ...
    $('.clicked4').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-2.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-2.jpg');
    });
    $('.clicked5').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-3.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-3.jpg');
    });
    $('.clicked6').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-4.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-4.jpg');
    });
    $('.clicked7').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-5.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-5.jpg');
    });
    $('.clicked8').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-6.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-6.jpg');
    });
    $('.clicked9').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-7.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-7.jpg');
    });
    // 10
    $('.clicked10').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-8.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-8.jpg');
    });
    $('.clicked11').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-9.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-9.jpg');
    });
    $('.clicked12').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-10.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-10.jpg');
    });
    $('.clicked13').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-11.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-11.jpg');
    });
    $('.clicked14').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-12.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-12.jpg');
    });
    // 15
    $('.clicked15').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-13.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-13.jpg');
    });
    // 16
    $('.clicked16').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-14.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-14.jpg');
    });
    $('.clicked17').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-15.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-15.jpg');
    });
    $('.clicked18').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-16.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-16.jpg');
    });
    $('.clicked19').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-17.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-17.jpg');
    });
    // 20
    $('.clicked20').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-18.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-18.jpg');
    });
    $('.clicked21').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-19.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-19.jpg');
    });
    $('.clicked22').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-20.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-20.jpg');
    });
    $('.clicked23').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-21.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-21.jpg');
    });
    $('.clicked24').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-22.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-22.jpg');
    });
    // 25
    $('.clicked25').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-23.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-23.jpg');
    });
    $('.clicked26').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-24.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-24.jpg');
    });
    $('.clicked27').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-25.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-25.jpg');
    });
    $('.clicked28').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-26.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-26.jpg');
    });
    $('.clicked29').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-27.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-27.jpg');
    });
    // 30
    $('.clicked30').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-28.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-28.jpg');
    });
    $('.clicked31').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-29.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-29.jpg');
    });
    $('.clicked32').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-30.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-30.jpg');
    });
    $('.clicked33').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-31.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-31.jpg');
    });
    $('.clicked34').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-32.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-32.jpg');
    });
    // 35
    $('.clicked35').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-33.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-33.jpg');
    });
    $('.clicked36').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-34.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-34.jpg');
    });
    $('.clicked37').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-35.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-35.jpg');
    });
    $('.clicked38').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-36.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-36.jpg');
    });
    $('.clicked39').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-37.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-37.jpg');
    });
    // 40
    $('.clicked40').on('click', function () {
        $('ol li img').removeClass('flex-active');
        $(this).addClass('flex-active');
        $('.firstImg').attr('src', 'img/soft-chair/shop-img-4-gallery-38.jpg');
        $('figure a').attr('href', 'img/soft-chair/shop-img-4-gallery-38.jpg');
    });
